...
__decorate([
    ...
    (0, class_validator_1.MinLength)(1, { message: 'Column name must not be empty' }),
    (0, class_validator_1.MaxLength)(50, { message: 'Column name must not exceed 50 characters' }),
